...
('Edit Member', array('action' => 'member_edit', $member['Member']['id'])); ?> </li>
        <li><?php echo $this->Html->link
('Delete Member', array('action' => 'member_delete', $member['Member']['id']),
null, sprintf('Are you sure you want to delete # %s?', $member['Member']['id'])); ?> </li>
        <li><?php echo $this->Html->link
('List Members', array('action' => 'member_index')); ?> </li>
        <li><?php echo $this->Html->link
('New Member', array('action' => 'member_add')); ?> </li>
    </ul>
</div>