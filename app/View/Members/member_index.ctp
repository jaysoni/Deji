...
array('action' => 'member_view', $member['Member']['id'])); ?>
            <?php echo $this->Html->link('Edit',
array('action' => 'member_edit', $member['Member']['id'])); ?>
            <?php echo $this->Html->link('Delete',
array('action' => 'member_delete', $member['Member']['id']), 
...
<div class="actions">
    <h3>Actions</h3>
    <ul>
        <li><?php echo $this->Html->link('New Member', array('action' => 'member_add')); ?></li>
    </ul>
</div>